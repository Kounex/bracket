...
- **Swiss:** Teams play a set number of rounds, and the number of rounds is based on the number of
  ...
  outcome of the previous rounds. When creating or editing a Swiss stage item, you can turn on
  **Competitive pairing**: similar records face each other (winners vs winners). Leave it
  off (the default, **social**) so everyone plays about equally often and opponents rotate.
